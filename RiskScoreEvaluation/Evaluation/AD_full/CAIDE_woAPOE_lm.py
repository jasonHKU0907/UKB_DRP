...
y_pred_prob_df.to_csv(dpath + 'Results/Results_RiskScores/AD/CAIDE_woAPOE/pred_prob_cv_df.csv')
y_test_df.to_csv(dpath + 'Results/Results_RiskScores/AD/CAIDE_woAPOE/test_cv_df.csv')

finaloutput = avg_results(results_cv)
finaloutput.to_csv(dpath + 'Results/Results_RiskScores/AD/CAIDE_woAPOE/results_cv.csv')
