...
y_pred_prob_df.to_csv(dpath + 'Results/Results_RiskScores/DM/CAIDE_APOE/pred_prob_cv_df.csv')
y_test_df.to_csv(dpath + 'Results/Results_RiskScores/DM/CAIDE_APOE/test_cv_df.csv')

finaloutput = avg_results(results_cv)
finaloutput.to_csv(dpath + 'Results/Results_RiskScores/DM/CAIDE_APOE/results_cv.csv')
