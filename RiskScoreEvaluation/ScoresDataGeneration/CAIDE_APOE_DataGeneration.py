...
mydf_age['age_caide'].loc[mydf_age['age_caide']>53] = 5
...
mydf_educ['educ_caide'].loc[mydf_educ['educ_caide']<=6] = 4
mydf_educ['educ_caide'].loc[(mydf_educ['educ_caide']>6) & (mydf_educ['educ_caide']<10)] = 3
...
mydf_chol['chol_caide'].loc[mydf_chol['chol_caide']>6.5] = 1
...
mydf_apoe = mydf[['eid', 'APOE4']]
mydf_apoe['apoe'] = mydf_apoe['APOE4']
mydf_apoe['apoe'].fillna(0, inplace = True)
mydf_apoe['apoe_caide'] = mydf_apoe['apoe']
mydf_apoe['apoe_caide'].loc[mydf_apoe['apoe_caide']>0] = 2
...
mydf_caide = pd.merge(mydf_caide, mydf_apoe[['eid', 'apoe_caide']], how='inner', on=['eid'])

mydf_caide.to_csv(dpath + 'Preprocessed_Data/ScoreData/CAIDE_data_APOE.csv')
print('finished')
