...
my_f = pd.read_csv(dpath + 'Results/Results_woHES/DM_5yrs/s01_DM_5yrs.csv')['Features'][:50].tolist()
...
fig.tight_layout()
plt.show()
plt.savefig(dpath + 'Results/Results_woHES/DM_5yrs/s02_DM_5yrs.png')
...
myout.to_csv(dpath + 'Results/Results_woHES/DM_5yrs/s02_DM_5yrs.csv')
