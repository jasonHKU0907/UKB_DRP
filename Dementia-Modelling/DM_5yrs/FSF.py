...
fimp_s03 = pd.read_csv(dpath + 'Results/Results_woHES/DM_5yrs/s03_DM_5yrs.csv')
fimp_s03.sort_values(by = 'Cover', ascending = False, inplace = True)
fimp_s04 = pd.read_csv(dpath + 'Results/Results_woHES/DM_5yrs/s04_DM_5yrs.csv')
...
#ax.set_title('5-year incident Dementia', y=1.0, pad=-25, weight='bold', fontsize=24)
ax.set_xlabel('')
...
plt.savefig(dpath + 'Results/Results_woHES/DM_5yrs/Cover_Imp_5yrs.png')
