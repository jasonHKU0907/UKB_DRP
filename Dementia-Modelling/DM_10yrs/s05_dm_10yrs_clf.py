...
my_f = pd.read_csv(dpath + 'Results/Results_woHES/DM_10yrs/s04_DM_10yrs.csv')['Features'][:10]
...
y_pred_prob_df.to_csv(dpath + 'Results/Results_woHES/DM_10yrs/pred_prob_cv_df.csv')
y_test_df.to_csv(dpath + 'Results/Results_woHES/DM_10yrs/test_cv_df.csv')

finaloutput = avg_results(results_cv)
finaloutput.to_csv(dpath + 'Results/Results_woHES/DM_10yrs/s05_DM_10yrs.csv')
