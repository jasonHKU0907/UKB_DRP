...
my_f = pd.read_csv(dpath + 'Results/Results_woHES/DM_10yrs/s01_DM_10yrs.csv')['Features'][:50].tolist()
...
fig.tight_layout()
plt.show()
plt.savefig(dpath + 'Results/Results_woHES/DM_10yrs/s02_DM_10yrs.png')
...
myout.to_csv(dpath + 'Results/Results_woHES/DM_10yrs/s02_DM_10yrs.csv')
