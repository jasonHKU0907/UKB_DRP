...
rm_f3 = ['CorrectMatchesEfficay1', 'CorrectMatchesEfficay2', 'CorrectMatchesEfficayAvg']
rm_f = rm_f1 + rm_HES + rm_f3
...
myout.to_csv(dpath + 'Results/Results_woHES/DM_full/s01_DM_full.csv')
