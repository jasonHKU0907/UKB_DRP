...
fimp_s03 = pd.read_csv(dpath + 'Results/Results_woHES/DM_full/s03_DM_full.csv')
fimp_s03.sort_values(by = 'Cover', ascending = False, inplace = True)
fimp_s04 = pd.read_csv(dpath + 'Results/Results_woHES/DM_full/s04_DM_full.csv')
fimp_s04['Unnamed: 0'] = fimp_s04['Unnamed: 0'] + 1
fimp_s04.rename(columns = {'Unnamed: 0': 'f_idx'}, inplace = True)
...
#ax.set_title('All incident Dementia', y=1.0, pad=-25, weight='bold', fontsize=24)
ax.set_xlabel('')
...
plt.savefig(dpath + 'Results/Results_woHES/DM_full/Cover_Imp_full.png')
