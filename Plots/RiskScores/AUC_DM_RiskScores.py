...
y_pred_ukbdrs_apoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/UKB_DRS_APOE/pred_prob_cv_df.csv')
y_test_ukbdrs_apoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/UKB_DRS_APOE/test_cv_df.csv')

y_pred_ukbdrs_woapoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/UKB_DRS/pred_prob_cv_df.csv')
y_test_ukbdrs_woapoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/UKB_DRS/test_cv_df.csv')
...
aucdf_ukbdrs_apoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/UKB_DRS_APOE/results_cv.csv')
aucdf_ukbdrs_woapoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/UKB_DRS/results_cv.csv')
aucdf_drs = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/DRS/results_cv.csv')
aucdf_caide_apoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/CAIDE_APOE/results_cv.csv')
aucdf_woapoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/CAIDE_woAPOE/results_cv.csv')
...
legend_full  = r'Our Model                       : ' + str(auc_mean_full) + '$\pm$' + str(auc_std_full)
...
legend_anuadri  = r'ANU-ADRI                       : ' + str(0.587) + '$\pm$' + str(0.015) + ' (p<0.01)'
...
plt.savefig(dpath + 'Results/Results_RiskScores/Plots/AUC_DM_RiskScores.png')
