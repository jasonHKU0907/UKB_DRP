...
ax[0, 0].set_xticks(x)
ax[0, 0].set_yticks([0, 5, 10, 15, 20, 25, 30, 35], fontsize = 12)
ax[0, 0].set_ylim(0,35)
ax[0, 0].legend(fontsize=18, loc = 2)
...
ax[0, 0].text(4.1, 35*0.75, sub_title, style='italic', fontsize=14)
...
ax[1, 0].set_xticks(x)
ax[1, 0].set_yticks([0, 5, 10, 15, 20, 25], fontsize = 12)
ax[1, 0].set_ylim(0,27)
...
ax[1, 0].text(4.1, 27*0.75, sub_title, style='italic', fontsize=14)
...
ax[2, 0].set_xticks(x)
ax[2, 0].set_yticks([0, 5, 10, 15, 20], fontsize = 12)
ax[2, 0].set_ylim(0,20)
ax[2, 0].legend(fontsize=18, loc = 2)
...
ax[2, 0].set_title(r'UKB-DRS (w/o ApoE' + ' ' + '$\epsilon 4)$', y=1.0, pad=-35, fontsize=22)
ax[2, 0].grid(which='major', alpha=0.5,  linestyle='--')
ax[2, 0].text(4.1, 20*0.75, sub_title, style='italic', fontsize=14)
...
ax[0, 1].legend(fontsize=18, loc = 2)
...
ax[0, 1].text(4.1, 25*0.75, sub_title, style='italic', fontsize=14)
...
ax[1, 1].set_xticks(x)
ax[1, 1].set_yticks([0, 5, 10, 15], fontsize = 12)
...
ax[1, 1].text(4.1, 18*0.75, sub_title, style='italic', fontsize=14)
...
ax[2, 1].set_xticks(x)
ax[2, 1].set_yticks([0, 2, 4, 6, 8, 10], fontsize = 12)
ax[2, 1].set_ylim(0,11)
ax[2, 1].legend(fontsize=18, loc = 2)
...
ax[2, 1].text(4.1, 11*0.75, sub_title, style='italic', fontsize=14)

fig.tight_layout()


fig.savefig(dpath + 'Results/Results_RiskScores/Plots/Calibration_AD_RiskScores_cali.png')
