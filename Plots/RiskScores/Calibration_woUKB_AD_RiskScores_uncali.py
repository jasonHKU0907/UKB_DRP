...
ax[0, 0].text(4.1, 70*0.8, sub_title, style='italic', fontsize=14)
ax[0, 0].text(-.5, 70*.95, 'A', weight = 'bold', fontsize=26)
...
ax[1, 0].text(4.1, 33*0.8, sub_title, style='italic', fontsize=14)
ax[1, 0].text(-.5, 33*.95, 'B', weight = 'bold', fontsize=26)
...
ax[0, 1].set_xticks(x)
ax[0, 1].set_yticks([0, 5, 10, 15, 20, 25], fontsize = 12)
...
ax[0, 1].text(4.1, 25*0.8, sub_title, style='italic', fontsize=14)
ax[0, 1].text(-.5, 25*.95, 'C', weight = 'bold', fontsize=26)
...
ax[1, 1].set_xticks(x)
#ax[1, 1].set_yticks([0, 5, 10, 15, 20, 25, 30], fontsize = 12)
...
ax[1, 1].text(4.1, 30*0.8, sub_title, style='italic', fontsize=14)
ax[1, 1].text(-.5, 30*.95, 'D', weight = 'bold', fontsize=26)

fig.tight_layout()


fig.savefig(dpath + 'Results/Results_RiskScores/Plots/woUKB/Calibration_AD_RiskScores_raw.png')
