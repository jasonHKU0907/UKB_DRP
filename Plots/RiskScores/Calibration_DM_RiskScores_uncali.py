...
ax[0, 0].text(4.1, 73*0.75, sub_title, style='italic', fontsize=14)
...
ax[0, 1].text(4.1, 50*0.75, sub_title, style='italic', fontsize=14)
...
ax[1, 1].text(4.1, 37*0.75, sub_title, style='italic', fontsize=14)
...
ax[2, 1].set_xticks(x)
ax[2, 1].set_yticks([0, 10, 20, 30, 40, 50, 60], fontsize = 12)
ax[2, 1].set_ylim(0,32)
...
ax[2, 1].text(4.1, 32*0.75, sub_title, style='italic', fontsize=14)

fig.tight_layout()


fig.savefig(dpath + 'Results/Results_RiskScores/Plots/Calibration_DM_RiskScores_raw.png')
