...
legend_full  = r'UKB-DRP (our model)     : ' + str(0.862) + '$\pm$' + str(0.015)
...
legend_anuadri  = r'ANU-ADRI                       : ' + str(0.568) + '$\pm$' + str(0.016) + ' (p<0.001)'
...
plt.savefig(dpath + 'Results/Results_RiskScores/Plots/woUKB/AUC_AD_RiskScores_woUKB_cali.png')
