...
aucdf_ukbdrs_apoe = pd.read_csv(dpath + 'Results/Results_RiskScores/AD/UKB_DRS_APOE/results_cv.csv')
aucdf_ukbdrs_woapoe = pd.read_csv(dpath + 'Results/Results_RiskScores/AD/UKB_DRS/results_cv.csv')
aucdf_drs = pd.read_csv(dpath + 'Results/Results_RiskScores/AD/DRS/results_cv.csv')
aucdf_caide_apoe = pd.read_csv(dpath + 'Results/Results_RiskScores/AD/CAIDE_APOE/results_cv.csv')
aucdf_woapoe = pd.read_csv(dpath + 'Results/Results_RiskScores/AD/CAIDE_woAPOE/results_cv.csv')
...
legend_ukbdrs_apoe  = r'UKB_DRS                        : ' + str(auc_mean_ukbdrs_apoe) + '$\pm$' + str(auc_std_ukbdrs_apoe) + ' (p<0.01)'
legend_ukbdrs_woapoe = r'UKB_DRS (w/o APOE ' + '$\epsilon 4):$' + ' ' + str(auc_mean_ukbdrs_woapoe) + '$\pm$' + str(auc_std_ukbdrs_woapoe) + ' (p<0.01)'
...
legend_anuadri  = r'ANU-ADRI                       : ' + str(0.578) + '$\pm$' + str(0.013) + ' (p<0.01)'
...
plt.savefig(dpath + 'Plots/AUC_AD_RiskScores.png')
