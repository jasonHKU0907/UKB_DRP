...
aucdf_5yrs = pd.read_csv(dpath + 'Results/Results_woHES/DM_5yrs/s05_DM_5yrs.csv')
aucdf_10yrs = pd.read_csv(dpath + 'Results/Results_woHES/DM_10yrs/s05_DM_10yrs.csv')
...
legend_full  = r'All incident dementia          : ' + str(auc_mean_full) + str(0) + '$\pm$' + str(auc_std_full)
...
plt.savefig(dpath + 'Results/Results_woHES/AUC.png')
