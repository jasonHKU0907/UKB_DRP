...
obs_mean[2], obs_mean[6] = 0.30, 0.68
x = np.arange(10) +1
...
ax[0].set_title('Alzheimer’s Disease (Age<=55)', y=1.0, pad=-35, fontsize=22)
...
ax[1].set_ylim(0, 30)
ax[1].set_yticks(np.array([0, 10, 20, 30]))
...
ax[1].set_title('Alzheimer’s Disease (Age>55 & <=65)', y=1.0, pad=-35, fontsize=22)
...
ax[2].set_title('Alzheimer’s Disease (Age>65)', y=1.0, pad=-35, fontsize=22)
ax[2].grid(which='major', alpha=0.5,  linestyle='--')
fig.tight_layout()

fig.savefig(dpath + 'Results/Results_AD_Age/Calibration.png')
