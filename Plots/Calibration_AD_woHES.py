...
obs_mean[0], obs_mean[1] = 0.16, 0.21
x = np.arange(10) +1
...
ax[0].text(4.1, 40*0.75, sub_title, style='italic', fontsize=14)
...
ax[1].text(4.1, 30*0.75, sub_title, style='italic', fontsize=14)
...
fig.savefig(dpath + 'Results/Results_AD_woHES/AD_woHES_Calibrate.png')
