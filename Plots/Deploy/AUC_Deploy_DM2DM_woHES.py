...
y_pred_5yrs = pd.read_csv(dpath + 'Results/Deploy/DM_5yrs/pred_prob_cv_df.csv')
y_test_5yrs = pd.read_csv(dpath + 'Results/Deploy/DM_5yrs/test_cv_df.csv')
y_pred_10yrs = pd.read_csv(dpath + 'Results/Deploy/DM_10yrs/pred_prob_cv_df.csv')
y_test_10yrs = pd.read_csv(dpath + 'Results/Deploy/DM_10yrs/test_cv_df.csv')
...
aucdf_5yrs = pd.read_csv(dpath + 'Results/Deploy/DM_5yrs/s05_DM_5yrs.csv')
aucdf_10yrs = pd.read_csv(dpath + 'Results/Deploy/DM_10yrs/s05_DM_10yrs.csv')
aucdf_full = pd.read_csv(dpath + 'Results/Deploy/DM_full/s05_DM_full.csv')
...
legend_5yrs  = r'5-year incident dementia    : ' + str(auc_mean_5yrs) + '$\pm$' + str(auc_std_5yrs)
legend_10yrs = r'10-year incident dementia  : ' + str(auc_mean_10yrs) + '$\pm$' + str(auc_std_10yrs)
legend_full  = r'All incident dementia          : ' + str(auc_mean_full) + '$\pm$' + str(auc_std_full)
...
plt.savefig(dpath + 'Results/Deploy/AUC_DM2DM.png')
