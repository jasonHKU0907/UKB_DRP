...
obs_mean[1], obs_mean[2], obs_mean[3], obs_mean[8] = 0.07, 0.16, 0.45, 9.01
...
ax[0].text(4.1, 38*0.75, sub_title, style='italic', fontsize=14)
...
ax[1].text(4.1, 28*0.75, sub_title, style='italic', fontsize=14)
...
fig.savefig(dpath + 'Results/Deploy/Calibration_AD2AD.png')
