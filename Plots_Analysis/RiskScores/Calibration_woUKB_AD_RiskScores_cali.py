...
ax[0, 0].text(4.1, 35*0.8, sub_title, style='italic', fontsize=14)
ax[0, 0].text(-.5, 35*.95, 'A', weight = 'bold', fontsize=26)
...
ax[1, 0].text(4.1, 25*0.8, sub_title, style='italic', fontsize=14)
ax[1, 0].text(-.5, 25*.95, 'B', weight = 'bold', fontsize=26)
...
ax[0, 1].set_xticks(x)
ax[0, 1].set_yticks([0, 5, 10, 15], fontsize = 12)
...
ax[0, 1].text(4.1, 18*0.8, sub_title, style='italic', fontsize=14)
ax[0, 1].text(-.5, 18*.95, 'C', weight = 'bold', fontsize=26)
...
ax[1, 1].set_xticks(x)
ax[1, 1].set_yticks([0, 2, 4, 6, 8, 10], fontsize = 12)
...
ax[1, 1].text(4.1, 11*0.8, sub_title, style='italic', fontsize=14)
ax[1, 1].text(-.5, 11*.95, 'D', weight = 'bold', fontsize=26)
