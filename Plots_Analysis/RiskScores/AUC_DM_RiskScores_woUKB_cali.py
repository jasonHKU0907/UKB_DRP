...
legend_full  = r'UKB-DRP (our model)     : ' + str(0.848) + '$\pm$' + str(0.007)
legend_drs  = r'DRS                                : ' + str(auc_mean_drs) + '$\pm$' + str(auc_std_drs) + ' (p<0.001)'
legend_caide_apoe  = r'CAIDE                             : ' + str(auc_mean_caide_apoe) + '$\pm$' + str(auc_std_caide_apoe) + ' (p<0.001)'
legend_caide_woapoe  = r'CAIDE (w/o ApoE ' + '$\epsilon 4)$' + '      : ' + str(auc_mean_caide_woapoe) + '$\pm$' + str(auc_std_caide_woapoe) + ' (p<0.001)'
legend_anuadri  = r'ANU-ADRI                       : ' + str(0.584) + '$\pm$' + str(0.017) + ' (p<0.001)'
...
plt.savefig(dpath + 'Results/Results_RiskScores/Plots/woUKB/AUC_DM_RiskScores_woUKB_cali.png')
