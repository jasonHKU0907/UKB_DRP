...
y_pred_full = pd.read_csv(dpath + 'Results/Deploy/DM_full/pred_prob_cv_df.csv')
y_test_full = pd.read_csv(dpath + 'Results/Deploy/DM_full/test_cv_df.csv')

y_pred_ukbdrs_apoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/UKB_DRS_APOE/pred_prob_cv_cali_df.csv')
y_test_ukbdrs_apoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/UKB_DRS_APOE/test_cv_cali_df.csv')

y_pred_ukbdrs_woapoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/UKB_DRS/pred_prob_cv_cali_df.csv')
y_test_ukbdrs_woapoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/UKB_DRS/test_cv_cali_df.csv')

y_pred_drs = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/DRS/pred_prob_cv_cali_df.csv')
y_test_drs = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/DRS/test_cv_cali_df.csv')

y_pred_caide_apoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/CAIDE_APOE/pred_prob_cv_cali_df.csv')
y_test_caide_apoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/CAIDE_APOE/test_cv_cali_df.csv')

y_pred_caide_woapoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/CAIDE_woAPOE/pred_prob_cv_cali_df.csv')
y_test_caide_woapoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/CAIDE_woAPOE/test_cv_cali_df.csv')

aucdf_full = pd.read_csv(dpath + 'Results/Results_woHES/DM_full/s05_DM_full.csv')
aucdf_ukbdrs_apoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/UKB_DRS_APOE/results_cali_cv.csv')
aucdf_ukbdrs_woapoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/UKB_DRS/results_cali_cv.csv')
aucdf_drs = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/DRS/results_cv.csv')
aucdf_caide_apoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/CAIDE_APOE/results_cali_cv.csv')
aucdf_woapoe = pd.read_csv(dpath + 'Results/Results_RiskScores/DM/CAIDE_woAPOE/results_cali_cv.csv')
...
legend_full  = r'Our Model                       : ' + str(0.848) + '$\pm$' + str(0.007)
...
legend_anuadri  = r'ANU-ADRI                       : ' + str(0.584) + '$\pm$' + str(0.017) + ' (p<0.01)'
...
for train_idx, test_idx in mykf.split(X, y):
    ...
    tpr[0] = 0.0
    tprs.append(np.array(tpr[:40]))
    fprs.append(np.array(fpr[:40]))
...
plt.savefig(dpath + 'Results/Results_RiskScores/Plots/AUC_DM_RiskScores_cali.png')
