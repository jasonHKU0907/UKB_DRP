...
ax[0, 0].text(4.1, 65*0.8, sub_title, style='italic', fontsize=14)
ax[0, 0].text(-.5, 65*.95, 'A', weight = 'bold', fontsize=26)
...
ax[1, 0].text(4.1, 45*0.8, sub_title, style='italic', fontsize=14)
ax[1, 0].text(-.5, 45*.95, 'B', weight = 'bold', fontsize=26)
...
ax[0, 1].set_xticks(x)
ax[0, 1].set_yticks([0, 5, 10, 15, 20, 25, 30, 35], fontsize = 12)
...
ax[0, 1].text(4.1, 35*0.8, sub_title, style='italic', fontsize=14)
ax[0, 1].grid(which='major', alpha=0.5,  linestyle='--')
ax[0, 1].text(-.5, 35*.95, 'C', weight = 'bold', fontsize=26)
...
ax[1, 1].legend(fontsize=18, loc = 2)
...
ax[1, 1].text(4.1, 25*0.8, sub_title, style='italic', fontsize=14)
ax[1, 1].text(-.5, 25*.95, 'D', weight = 'bold', fontsize=26)

fig.tight_layout()


fig.savefig(dpath + 'Results/Results_RiskScores/Plots/woUKB/Calibration_DM_RiskScores_cali.png')
