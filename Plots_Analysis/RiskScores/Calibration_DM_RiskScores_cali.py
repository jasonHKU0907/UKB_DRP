...
ax[0, 0].set_xticks(x)
ax[0, 0].set_yticks([0, 10, 20, 30, 40, 50, 60], fontsize = 12)
...
ax[0, 0].text(4.1, 65*0.75, sub_title, style='italic', fontsize=14)
...
ax[1, 0].text(4.1, 52*0.75, sub_title, style='italic', fontsize=14)
...
ax[2, 0].text(4.1, 42*0.75, sub_title, style='italic', fontsize=14)
...
ax[0, 1].text(4.1, 45*0.75, sub_title, style='italic', fontsize=14)
...
ax[1, 1].set_xticks(x)
ax[1, 1].set_yticks([0, 5, 10, 15, 20, 25, 30, 35], fontsize = 12)
...
ax[1, 1].text(4.1, 35*0.75, sub_title, style='italic', fontsize=14)
...
ax[2, 1].set_xticks(x)
ax[2, 1].set_yticks([0, 5, 10, 15, 20, 25], fontsize = 12)
ax[2, 1].set_ylim(0,25)
...
ax[2, 1].text(4.1, 25*0.75, sub_title, style='italic', fontsize=14)

fig.tight_layout()


fig.savefig(dpath + 'Results/Results_RiskScores/Plots/Calibration_DM_RiskScores_cali.png')
#plt.savefig(dpath + 'Results/Results_RiskScores/Plots/Calibration_DM_RiskScores_cali.pdf')
