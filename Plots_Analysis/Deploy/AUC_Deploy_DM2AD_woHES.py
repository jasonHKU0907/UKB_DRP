...
aucdf_5yrs = pd.read_csv(dpath + 'Results/Deploy/AD_5yrs/s05_AD_5yrs.csv')
aucdf_10yrs = pd.read_csv(dpath + 'Results/Deploy/AD_10yrs/s05_AD_10yrs.csv')
aucdf_full = pd.read_csv(dpath + 'Results/Deploy/AD_full/s05_AD_full.csv')
...
legend_5yrs  = r'5-year incident AD   : ' + str(auc_mean_5yrs) + str(0) + '$\pm$' + str(auc_std_5yrs)
...
plt.legend(loc=4, fontsize = 24, labelspacing = 1.5)
...
plt.savefig(dpath + 'Results/Deploy/AUC_DM2AD1.png')
