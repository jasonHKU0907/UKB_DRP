...
y_pred_5yrs = pd.read_csv(dpath + 'Results/Deploy/AD2AD_5yrs/pred_prob_cv_df.csv')
y_test_5yrs = pd.read_csv(dpath + 'Results/Deploy/AD2AD_5yrs/test_cv_df.csv')
y_pred_10yrs = pd.read_csv(dpath + 'Results/Deploy/AD2AD_10yrs/pred_prob_cv_df.csv')
y_test_10yrs = pd.read_csv(dpath + 'Results/Deploy/AD2AD_10yrs/test_cv_df.csv')
y_pred_full = pd.read_csv(dpath + 'Results/Deploy/AD2AD_full/pred_prob_cv_df.csv')
y_test_full = pd.read_csv(dpath + 'Results/Deploy/AD2AD_full/test_cv_df.csv')

aucdf_5yrs = pd.read_csv(dpath + 'Results/Deploy/AD2AD_5yrs/s05_AD_5yrs.csv')
aucdf_10yrs = pd.read_csv(dpath + 'Results/Deploy/AD2AD_10yrs/s05_AD_10yrs.csv')
aucdf_full = pd.read_csv(dpath + 'Results/Deploy/AD2AD_full/s05_AD_full.csv')
...
plt.savefig(dpath + 'Results/Deploy/AUC_AD2AD.png')
