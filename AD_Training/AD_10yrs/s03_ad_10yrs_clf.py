...
my_f = pd.read_csv(dpath + 'Results/Results_AD_woHES/AD_10yrs/s02_AD_10yrs.csv')['Features'].tolist()
...
myout.to_csv(dpath + 'Results/Results_AD_woHES/AD_10yrs/s03_AD_10yrs.csv')
