...
my_f = pd.read_csv(dpath + 'Results/Results_AD_woHES/AD_10yrs/s04_AD_10yrs.csv')['Features'][:10]
...
y_pred_prob_df.to_csv(dpath + 'Results/Results_AD_woHES/AD_10yrs/pred_prob_cv_df.csv')
y_test_df.to_csv(dpath + 'Results/Results_AD_woHES/AD_10yrs/test_cv_df.csv')

finaloutput = avg_results(results_cv)
finaloutput.to_csv(dpath + 'Results/Results_AD_woHES/AD_10yrs/s05_AD_10yrs.csv')
print(finaloutput.iloc[:30, :9])
