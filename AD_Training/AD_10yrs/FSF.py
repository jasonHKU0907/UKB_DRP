...
fimp_s03 = pd.read_csv(dpath + 'Results/Results_AD_woHES/AD_10yrs/s03_AD_10yrs.csv')
fimp_s03.sort_values(by = 'Cover', ascending = False, inplace = True)
fimp_s04 = pd.read_csv(dpath + 'Results/Results_AD_woHES/AD_10yrs/s04_AD_10yrs.csv')
...
plt.savefig(dpath + 'Results/Results_AD_woHES/AD_10yrs/Cover_Imp_10yrs.png')
