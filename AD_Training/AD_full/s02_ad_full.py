...
my_f = pd.read_csv(dpath + 'Results/Results_AD_woHES/AD_full/s01_AD_full.csv')['Features'][:50].tolist()
...
fig.tight_layout()
plt.show()
plt.savefig(dpath + 'Results/Results_AD_woHES/AD_full/s02_AD_full.png')
...
myout.to_csv(dpath + 'Results/Results_AD_woHES/AD_full/s02_AD_full.csv')
