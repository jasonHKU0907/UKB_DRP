...
for train_idx, test_idx in mykf.split(X, y):
    ...
    X_train_gbm, X_train_cali = X_train[68025:], X_train[:150000]
    y_train_gbm, y_deploy_train_cali = y_train[68025:], y_deploy_train[:150000]
...
y_pred_prob_df.to_csv(dpath + 'Results/Deploy/AD2AD_10yrs/pred_prob_cv_df.csv')
y_test_df.to_csv(dpath + 'Results/Deploy/AD2AD_10yrs/test_cv_df.csv')

finaloutput = avg_results(results_cv)
finaloutput.to_csv(dpath + 'Results/Deploy/AD2AD_10yrs/s05_AD_10yrs.csv')
