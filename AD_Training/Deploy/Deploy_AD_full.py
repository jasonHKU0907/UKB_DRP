...
y_pred_prob_df.to_csv(dpath + 'Results/Deploy/AD2AD_full/pred_prob_cv_df.csv')
y_test_df.to_csv(dpath + 'Results/Deploy/AD2AD_full/test_cv_df.csv')

finaloutput = avg_results(results_cv)
finaloutput.to_csv(dpath + 'Results/Deploy/AD2AD_full/s05_AD_full.csv')
