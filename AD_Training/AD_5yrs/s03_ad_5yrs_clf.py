...
my_f = pd.read_csv(dpath + 'Results/Results_AD_woHES/AD_5yrs/s02_AD_5yrs.csv')['Features'].tolist()
...
myout.to_csv(dpath + 'Results/Results_AD_woHES/AD_5yrs/s03_AD_5yrs.csv')
print('finished')
