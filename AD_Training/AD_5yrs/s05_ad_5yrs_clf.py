...
y_pred_prob_df.to_csv(dpath + 'Results/Results_AD_woHES/AD_5yrs/pred_prob_cv_df.csv')
y_test_df.to_csv(dpath + 'Results/Results_AD_woHES/AD_5yrs/test_cv_df.csv')

finaloutput = avg_results(results_cv)
finaloutput.to_csv(dpath + 'Results/Results_AD_woHES/AD_5yrs/s05_AD_5yrs.csv')
