...
fimp_s03 = pd.read_csv(dpath + 'Results/Results_AD_woHES/AD_full/s03_AD_full.csv')
fimp_s03.sort_values(by = 'Cover', ascending = False, inplace = True)
fimp_s04 = pd.read_csv(dpath + 'Results/Results_AD_woHES/AD_full/s04_AD_full.csv')
...
#ax.set_title('All incident AD', y=1.0, pad=-25, weight='bold', fontsize=24)
ax.set_xlabel('')
...
plt.savefig(dpath + 'Results/Results_AD_woHES/AD_full/Cover_Imp_full.png')
