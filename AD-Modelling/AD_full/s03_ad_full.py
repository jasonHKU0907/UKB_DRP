...
my_f = pd.read_csv(dpath + 'Results/Results_AD_woHES/AD_full/s02_AD_full.csv')['Features'].tolist()
...
myout.to_csv(dpath + 'Results/Results_AD_woHES/AD_full/s03_AD_full.csv')
