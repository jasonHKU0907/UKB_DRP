...
my_f = pd.read_csv(dpath + 'Results/Results_AD_woHES/AD_5yrs/s01_AD_5yrs.csv')['Features'][:50].tolist()
...
fig.tight_layout()
plt.show()
plt.savefig(dpath + 'Results/Results_AD_woHES/AD_5yrs/s02_AD_5yrs.png')
...
myout.to_csv(dpath + 'Results/Results_AD_woHES/AD_5yrs/s02_AD_5yrs.csv')
