...
fimp_s03 = pd.read_csv(dpath + 'Results/Results_AD_woHES/AD_5yrs/s03_AD_5yrs.csv')
fimp_s03.sort_values(by = 'Cover', ascending = False, inplace = True)
fimp_s04 = pd.read_csv(dpath + 'Results/Results_AD_woHES/AD_5yrs/s041_AD_5yrs.csv')
fimp_s04['f_idx'] = fimp_s04['Unnamed: 0'] + 1
mylabel = match_labels(fimp_s04['Features'], dict_f)
mylabel.iloc[2] = r'ApoE' + ' ' + '$\epsilon 4$'
...
fimp_tc['AUC_lower'] = fimp_tc['AUC_mean'] - 1*fimp_tc['AUC_std']
fimp_tc['AUC_upper'] = fimp_tc['AUC_mean'] + 1*fimp_tc['AUC_std']
...
#ax.set_title('5-year incident AD', y=1.0, pad=-25, weight='bold', fontsize=24)
ax.set_xlabel('')
...
plt.savefig(dpath + 'Results/Results_AD_woHES/AD_5yrs/Cover_Imp_5yrs.png')
